...
public class MouseEventsSample extends Application {
	...
	final Rectangle rectangle = RectangleBuilder.create().width(450).height(300).fill(new LinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE, new Stop[] {
